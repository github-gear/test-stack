...
},{"window-handle":4}],2:[function(require,module,exports){
var $bs;
...
},{"./decorator":1,"jquery-detached-2.1.4":3}],3:[function(require,module,exports){
var sharedJQuery;
...
},{"window-handle":4}],4:[function(require,module,exports){
var theWindow;
...
},{"./internal":6,"./promise":7}],6:[function(require,module,exports){
var promise = require("./promise");
...
},{"./promise":7,"window-handle":8}],7:[function(require,module,exports){
/*
...
},{"jenkins-js-modules":5}],10:[function(require,module,exports){
var internal = require("./internal");
var promise = require("./promise");
var onRegisterTimeout;
var whoami;
...
},{"../util/jenkins":31,"./plugins.js":16}],16:[function(require,module,exports){
//
...
},{"../util/jenkins":31}],18:[function(require,module,exports){
...
},{"./pluginSetupWizardGui":19,"jenkins-js-modules":10}],19:[function(require,module,exports){
/**
...
},{"./api/pluginManager":15,"./api/securityConfig":17,"./templates/errorPanel.hbs":20,"./templates/firstUserPanel.hbs":21,"./templates/incompleteInstallationPanel.hbs":22,"./templates/loadingPanel.hbs":23,"./templates/offlinePanel.hbs":24,"./templates/pluginSelectionPanel.hbs":25,"./templates/pluginSetupWizard.hbs":26,"./templates/progressPanel.hbs":27,"./templates/proxyConfigPanel.hbs":28,"./templates/setupCompletePanel.hbs":29,"./templates/welcomePanel.hbs":30,"./util/jenkins":31,"bootstrap-detached":2,"jenkins-js-modules":10}],20:[function(require,module,exports){
...
},{"jenkins-handlebars-rt/runtimes/handlebars3_rt":9}],21:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('jenkins-handlebars-rt/runtimes/handlebars3_rt');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, helper, alias1=this.lambda, alias2=this.escapeExpression;
...
},{"jenkins-handlebars-rt/runtimes/handlebars3_rt":9}],22:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('jenkins-handlebars-rt/runtimes/handlebars3_rt');
...
},{"jenkins-handlebars-rt/runtimes/handlebars3_rt":9}],23:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('jenkins-handlebars-rt/runtimes/handlebars3_rt');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"jenkins-handlebars-rt/runtimes/handlebars3_rt":9}],24:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('jenkins-handlebars-rt/runtimes/handlebars3_rt');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, alias1=this.lambda, alias2=this.escapeExpression;
...
},{"jenkins-handlebars-rt/runtimes/handlebars3_rt":9}],25:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('jenkins-handlebars-rt/runtimes/handlebars3_rt');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "				<div class=\"plugin "
    ...
    + " "
    + ((stack1 = (helpers.ifVisibleDependency || (depth0 && depth0.ifVisibleDependency) || alias1).call(depth0,((stack1 = (depth0 != null ? depth0.plugin : depth0)) != null ? stack1.name : stack1),{"name":"ifVisibleDependency","hash":{},"fn":this.program(9, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\" id=\"row-"
    + alias3(alias2(((stack1 = (depth0 != null ? depth0.plugin : depth0)) != null ? stack1.name : stack1), depth0))
    + "\">\n"
    ...
    + alias3(alias2(((stack1 = (depth0 != null ? depth0.plugin : depth0)) != null ? stack1.name : stack1), depth0))
    + "\" value=\""
    + alias3(((helper = (helper = helpers.searchTerm || (depth0 != null ? depth0.searchTerm : depth0)) != null ? helper : alias1),(typeof helper === "function" ? helper.call(depth0,{"name":"searchTerm","hash":{},"data":data}) : helper)))
    + "\" "
    + ((stack1 = (helpers.inSelectedPlugins || (depth0 && depth0.inSelectedPlugins) || alias1).call(depth0,((stack1 = (depth0 != null ? depth0.plugin : depth0)) != null ? stack1.name : stack1),{"name":"inSelectedPlugins","hash":{},"fn":this.program(13, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "/>\n							"
    + alias3(alias2(((stack1 = (depth0 != null ? depth0.plugin : depth0)) != null ? stack1.title : stack1), depth0))
    + "\n						</span>\n						<span class=\"description\">\n							"
    + ((stack1 = alias2(((stack1 = (depth0 != null ? depth0.plugin : depth0)) != null ? stack1.excerpt : stack1), depth0)) != null ? stack1 : "")
    + "\n						</span>\n"
    + ((stack1 = (helpers.hasDependencies || (depth0 && depth0.hasDependencies) || alias1).call(depth0,((stack1 = (depth0 != null ? depth0.plugin : depth0)) != null ? stack1.name : stack1),{"name":"hasDependencies","hash":{},"fn":this.program(15, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "					</label>\n				</div>\n";
  ...
  return "						<div class=\"btn btn-link toggle-dependency-list\" type=\"button\" data-plugin-name=\""
  ...
  return "							<div class=\"dep-list\">\n"
    + ((stack1 = (helpers.eachDependency || (depth0 && depth0.eachDependency) || helpers.helperMissing).call(depth0,((stack1 = (depths[1] != null ? depths[1].plugin : depths[1])) != null ? stack1.name : stack1),{"name":"eachDependency","hash":{},"fn":this.program(16, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "							</div>\n";
},"16":function(depth0,helpers,partials,data) {
    var helper;

  return "								<span class=\"dep badge\">\n								"
  ...
  return "<div class=\"modal-header\">\n	<h4 class=\"modal-title\">"
    ...
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.selectedPlugins : depth0),{"name":"each","hash":{},"fn":this.program(3, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    ...
    + "</div>\n"
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.categorizedPlugins : depth0),{"name":"each","hash":{},"fn":this.program(5, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "		</div>\n	</div>\n</div>\n<div class=\"modal-footer\">\n	<button type=\"button\" class=\"btn btn-link install-home\">\n		"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.translations : depth0)) != null ? stack1.installWizard_goBack : stack1), depth0))
...
},{"jenkins-handlebars-rt/runtimes/handlebars3_rt":9}],26:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('jenkins-handlebars-rt/runtimes/handlebars3_rt');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
...
},{"jenkins-handlebars-rt/runtimes/handlebars3_rt":9}],27:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('jenkins-handlebars-rt/runtimes/handlebars3_rt');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    var helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;
...
},{"jenkins-handlebars-rt/runtimes/handlebars3_rt":9}],28:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('jenkins-handlebars-rt/runtimes/handlebars3_rt');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, helper, alias1=this.lambda, alias2=this.escapeExpression;
...
},{"jenkins-handlebars-rt/runtimes/handlebars3_rt":9}],29:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('jenkins-handlebars-rt/runtimes/handlebars3_rt');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    var stack1, alias1=this.lambda, alias2=this.escapeExpression;
...
},{"jenkins-handlebars-rt/runtimes/handlebars3_rt":9}],30:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('jenkins-handlebars-rt/runtimes/handlebars3_rt');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var stack1, alias1=this.lambda, alias2=this.escapeExpression;
...
},{"jenkins-handlebars-rt/runtimes/handlebars3_rt":9}],31:[function(require,module,exports){
/**
...
},{"jenkins-js-modules":10,"window-handle":14}]},{},[18]);
